  ...
  return (
    ...
    >
      <div className="max-w-6xl">
        ...
        <p className="reveal font-body mt-8 sm:mt-10 text-base sm:text-lg md:text-xl text-black/50 tracking-wide max-w-xl leading-relaxed">
          Say less.{" "}
        ...
        <p className="reveal font-body mt-6 sm:mt-8 text-sm sm:text-base md:text-lg text-black/45 leading-relaxed max-w-2xl">
        ...
        <p className="reveal font-body mt-4 sm:mt-6 text-sm sm:text-base text-black/40 leading-relaxed max-w-2xl">
