      ...
      <div className="grid grid-cols-1 gap-10 place-items-center sm:flex sm:flex-col sm:gap-20 md:gap-40">
        {projects.map((project, i) => {
          ...
          return (
            ...
            >
              <div
                className={`project-image relative flex items-center justify-center min-h-56 sm:min-h-90 md:min-h-115 order-1 w-full ${
                  isReversed ? "lg:order-1" : "lg:order-2"
                }`}
              >
                <div className="relative w-full h-56 sm:h-90 md:h-115">
                  <Image
                    src={project.image}
                    alt={project.alt}
                    fill
              ...
              >
                ...
                <h3 className="font-display text-[clamp(1.25rem,4vw,4rem)] uppercase leading-[0.95] tracking-tight text-black">
                  {project.title}
                </h3>

                <p className="font-body text-sm sm:text-lg md:text-xl leading-relaxed text-black/55 max-w-lg line-clamp-3 sm:line-clamp-none">
                  {project.description}
                </p>
              </div>
            </article>
